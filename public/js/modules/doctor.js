        ...
        this.diagnostique = (a) => {
            ...
            switch (a.maladie) {
                case diagnostique[0].maladie:
                    ...
                    return `la maladie de ${Patients[0].nom} est ${diagnostique[0].maladie} et son traitement a prendre est ${diagnostique[0].traitement} et son prix coute ${traitements[0].prix}$`

                    break;
                case diagnostique[1].maladie:
                    a.traitement.push(diagnostique[1].traitement)
                    a.traitement.push(traitements[1].prix)
                    return `la maladie de ${Patients[0].nom} est ${diagnostique[1].maladie} et son traitement a prendre est ${diagnostique[1].traitement} et son prix coute ${traitements[1].prix}$`

                    break;
                case diagnostique[2].maladie:
                    a.traitement.push(traitements[2].prix)
                    a.traitement.push(diagnostique[2].traitement)
                    return `la maladie de ${Patients[0].nom} est ${diagnostique[2].maladie} et son traitement a prendre est ${diagnostique[2].traitement} et son prix coute ${traitements[2].prix}$`
                    
                    break;
                case diagnostique[3].maladie:
                    a.traitement.push(diagnostique[3].traitement)
                    a.traitement.push(traitements[3].prix)
                    return `la maladie de ${Patients[0].nom} est ${diagnostique[3].maladie} et son traitement a prendre est ${diagnostique[3].traitement} et son prix coute ${traitements[3].prix}$`
                    
                    break;
                case diagnostique[4].maladie:
                    a.traitement.push(diagnostique[4].traitement)
                    a.traitement.push(traitements[4].prix)
                    return `la maladie de ${Patients[0].nom} est ${diagnostique[4].maladie} et son traitement a prendre est ${diagnostique[4].traitement} et son prix coute ${traitements[4].prix}$` 
